...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/quart-trio-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/quart-trio-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install quart-trio
```
...
It is possible to list all of the versions of `quart-trio` available on your platform:
...
```
pixi search quart-trio --channel conda-forge
```
